...
func RUNENGINE() {
	...
	userGroup :=r.Group("/user")
	{
		...
		userGroup.POST("/getuserinfobyusername",getuserinfobyusername)
	...
	longpostGroup:=r.Group("/longpost")
	{
		...
		longpostGroup.PUT("/updatelongpost",JWTAuthMiddleware(),updatelongpost)
		longpostGroup.GET("/longpostsofuser",JWTAuthMiddleware(),getlongpostbyusername)
	}
